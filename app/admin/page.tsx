...
export default function AdminPage() {
  const clayBase = "group relative p-6 rounded-[2rem] font-bold text-center transition-all duration-500 flex flex-col items-center justify-center gap-4 text-white shadow-[inset_-4px_-4px_8px_rgba(0,0,0,0.2),inset_4px_4px_8px_rgba(255,255,255,0.3),4px_4px_16px_rgba(0,0,0,0.1)] hover:shadow-[inset_-6px_-6px_12px_rgba(0,0,0,0.25),inset_6px_6px_12px_rgba(255,255,255,0.4),8px_8px_24px_rgba(0,0,0,0.15)] hover:-translate-y-2 border border-white/10";
