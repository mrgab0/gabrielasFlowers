      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden py-16 md:py-24 bg-gradient-to-b from-[#fff0ef]/60 via-transparent to-transparent dark:from-[#181922]/60 dark:via-transparent dark:to-transparent border-b border-[#D4AF37]/20">
          <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center space-y-4">
              ...
              {/* Kicker */}
              <div className="inline-flex items-center gap-2 bg-[#fff0ef] dark:bg-pink-950/60 text-[#8B0024] dark:text-pink-300 border border-[#D4AF37]/40 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-[0.2em] shadow-sm">
                <Sparkles size={13} className="text-[#D4AF37]" />
                <span>Boutique Floral & Storytelling</span>
              </div>

              {/* Título Principal */}
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif font-black text-gray-900 dark:!text-white tracking-tight leading-tight">
                Detalles que <span className="text-[#FF97A4]">Enamoran</span>
              </h1>

              {/* Resumen de Historia */}
              <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300 leading-relaxed font-medium pt-2">
                En <strong>Gabriela's Flowers LLC</strong>, nacimos en Pasadena y Houston, Texas con un solo propósito: transformar cada sentimiento en una obra de arte floral inolvidable. Seleccionamos las rosas y flores más frescas de exportación para confeccionar ramos buchones, cajas de lujo y arreglos exclusivos que celebran la vida, el amor y los momentos que perduran.
              </p>

              <div className="flex flex-wrap justify-center items-center gap-4 text-xs font-bold text-gray-600 dark:text-gray-400 pt-2">
                <span className="flex items-center gap-1">
                  <MapPin size={15} className="text-[#8B0024] dark:text-[#FF97A4]" /> Houston & Pasadena, TX
                </span>
                <span>•</span>
                <span className="flex items-center gap-1">
                ...
                <span>•</span>
                <span className="flex items-center gap-1">
                  <Heart size={15} className="text-[#FF97A4]" /> Floristas Expertos
                </span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-14">
              ...
              <div className="bg-white/80 dark:bg-[#181922]/80 backdrop-blur-md p-6 sm:p-8 rounded-3xl border border-[#D4AF37]/25 shadow-[0_4px_20px_rgba(42,0,2,0.05)] hover:shadow-lg hover:-translate-y-1 transition-all">
                ...
                <h3 className="font-serif font-black text-lg text-gray-900 dark:!text-white mb-2">
          ...
          <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-gray-200 dark:border-gray-800 pb-6">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl sm:text-4xl font-serif font-black text-gray-900 dark:!text-white">
            ...
            {filteredPosts.length === 0 ? (
              <div className="text-center py-16 bg-white dark:bg-[#181922] rounded-3xl border border-gray-200 dark:border-gray-800 p-8">
                <p className="text-sm font-bold text-gray-500">No hay artículos en esta categoría en este momento.</p>
              </div>
            ) : (
                    ...
                    <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                      <div className="space-y-2.5">
                        <div className="flex items-center gap-2 text-[11px] text-gray-500 dark:text-gray-400 font-bold">
                          <Calendar size={13} className="text-[#FF97A4]" />
                        ...
                        <Link href={`/nosotros/${post.slug}`}>
                          <h3 className="font-serif font-black text-lg text-gray-900 dark:!text-white group-hover:text-[#8B0024] dark:group-hover:text-[#FF97A4] transition-colors line-clamp-2 leading-snug">
                            {post.title}
                          </h3>
                        </Link>

                        <p className="text-xs text-gray-600 dark:text-gray-300 line-clamp-3 leading-relaxed font-medium">
                      ...
                      <div className="pt-3 border-t border-gray-100 dark:border-gray-800">
                        <Link
                          ...
                          className="inline-flex items-center gap-1.5 text-xs font-black text-[#8B0024] dark:text-pink-300 group-hover:translate-x-1 transition-transform"
                        >
        ...
        <section className="py-14 bg-gradient-to-r from-pink-50 via-rose-50 to-pink-50 dark:from-[#181922] dark:via-[#20171d] dark:to-[#181922] border-t border-[#D4AF37]/20">
          <div className="max-w-4xl mx-auto px-4 text-center space-y-5">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300 max-w-xl mx-auto font-medium leading-relaxed">
